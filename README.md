...
- Pohyb je až ***10m*** za kolo *(do blízké vzdálenosti)*, může být libovolně rozdělen. Při lezení, plavání a nebo v obtížném terénu se pohybuješ poloviční rychlostí *(zaokrouhluje se dolů).*
- Skrze pozice spojenců se můžeš pohnout libovolně, u nepřátel je potřeba hod na sílu nebo obratnost.
- Vzdálenosti jsou rozlišeny na tři skupiny: **na dosah**, **blízko** *(do 10 m)* a **daleko** *(až na dohled)*. 
- Vypravěč může požadovat hod kostkou *(k20\+bonus),* když akce může mít negativní následky, vyžaduje zručnost a nebo když je postava tlačena časem. Standardně obtížnost je OB12.
- Vlastnosti mají hodnotu, které se říká *bonus/modifikátor*, který se pak přidává k hodům kostkou *k20* a dalším schopnostem:  
  * Síla: útoky zblízka, nosnost a atletika.  
  * Obratnost: útoky na dálku a nenápadnost.  
  * Odolnost: životy a houževnatost.  
  * Inteligence: znalosti a kouzelnictví.  
  * Moudrost: vnímání a kněžství.  
  * Charisma: síla osobnosti a přesvědčování.
...
- **Kouzelný svitek** je zničen při použití bez ohledu na úspěch, **kouzelná hůlka** je při normálním neúspěchu vybita a během řádného odpočinku se nabije. Při kritickém neúspěchu je hůlka zničena.
...
**Vzácné:** nebeština, démonština, drakonština, prastarština *(prastaré bytosti a elementálové)*.
...
- **Životy:** k6 za každou úroveň.
- **Vybavení:** lehké zbroje a zlodějské zbraně.
...
- **Detekce magie**: \[soustředění, blízko\], cítíš přítomnost blízké magie, po dvou kolech rozeznáš obecné vlastnosti.  
- **Hořící ruce**: \[okamžité, blízko\], vychrlíš kužel plamene do blízké oblasti, všichni v oblasti dostanou k6 poškození, hořlavé předměty se vznítí.  
- **Levitující disk**: \[10 kol, blízko\], vytvoř disk, který unese až 20 slotů vybavení po dobu 10 kol. Nedokáže překonávat propasti.  
- **Magická střela**: \[okamžité, daleko\], seslání vždy s výhodou, vystřelíš zářící střelu energie, cíl dostane k4 magického poškození.  
...
3. **Mentální jizva**: týden toto kouzlo nemůžeš seslat.
4. **Masemnice**: každé kolo ti magický červ vyčerpá připravené kouzlo, OB 12 odolnost *(akce)* na vypuzení.
5. **Horror**: 3 kola křičíš v prastarém jazyku *(nelze kouzlit)*, upoutáváš nechtěnou pozornost.
6. **Nestabilní vedení**: nevýhody na seslání kouzel na 10 kol.
